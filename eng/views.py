...
def faq(request):
    ...
    return render(request, 'eng/FAQ.html', context)
...
def useful(request):
    ...
    return render(request, 'eng/Useful_Information.html', context)
...
def contact(request):
    ...
    return render(request, 'eng/Contact.html')
        ...
        if results.exists():
            for post in posts:
                if post.search_s == result:
                    ...
                    return render(request, 'eng/search.html', context)
        else:
...
def detail_faq(request, post_id):
    ...
    return render(request, 'eng/detail.html', {'post': faq})


def detail_useful(request, post_id):
    useful = get_object_or_404(Useful, pk=post_id)
    return render(request, 'eng/detail.html', {'post': useful})